...
var input = process.env.HOST;
var fields = input.split(',');

var host=fields[0];

var validtoken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsInRhc2siOiJjaGFsbGVuZ2UifQ.eyJUYXNrIjoiQ2hhbGxlbmdlIiwiQ29tcGFueSI6Ik1pOSIsImlhdCI6MTQ0NTI1ODIzMiwiZXhwIjoxNDUwNDQyMjMyLCJhdWQiOiJhY2NvdW50IGhvbGRlcnMiLCJpc3MiOiJNaTkiLCJzdWIiOiJTaG93cyJ9.VA1LBt6yLxRdwuA-Il8H02h-bkhTNeelWNwUTjQnS9y1u9E6jJFT0MOK19Z3uh8YdhwIuBn6wFP1qOSWRR845imUlavfD3tbWG77RlIaGB_aoCg1IihJihMhyHREeQjvICiK8u119w4lQO3HxeIfk5ykF48aCK4Baf_6R1fOeec";
var invalidtoken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsInRhc2siOiJjaGFsbGVuZ2UifQ.eyJUYXNrIjoiQ2hhbGxlbmdlIiwiQ29tcGFueSI6Ik1pOSIsImlhdCI6MTQ0NTI1ODIzMiwiZXhwIjoxNDUwNDQyMjMyLCJhdWQiOiJhY2NvdW50IGhvbGRlcnMiLCJpc3MiOiJNaTkiLCJzdWIiOiJTaG93cyJ9.VA1LBt6yLxRdwuA-Il8H02h-bkhTNeelWNwUTjQnS9y1u9E6jJFT0MOK19Z3uh8YdhwIuBn6wFP1qOSWRR845imUlavfD3tbWG77RlIaGB_aoCg1IihJihMhyHREeQjvICiK8u119w4lQO3HxeIfk5ykF48aCK4Baf_6R1fOeecx";
...
// valid tokens secured
frisby.create('Post and receive filtered shows list  with valid token at ' + host )
  .post(host + 'api/challenge' + '?access_token=' + validtoken,  shows)
  .inspectJSON()
  .expectStatus(200)
  .expectJSONTypes({
      response: Object
...
.toss();
frisby.create('Post null and receive 400 error with valid token' + host )
  .post(host + 'api/challenge' + '?access_token=' + validtoken,  null)
  .inspectJSON()
  .expectStatus(400)
  .expectJSONTypes({
      response: Object
...
frisby.create('Post undefined and receive 400 error with valid' + host )
  .post(host + 'api/challenge' + '?access_token=' + validtoken)
  .inspectJSON()
  .expectStatus(400)
  .expectJSONTypes({
      response: Object
...
// invalid tokens secured
frisby.create('Post and receive filtered shows list  with invalid token at ' + host )
  .post(host + 'api/challenge' + '?access_token=' + invalidtoken,  shows)
  .inspectJSON()
  .expectStatus(400)
  .expectJSONTypes({
      response: Object
...
.toss();
frisby.create('Post null and receive 400 error with valid token' + host )
  .post(host + 'api/challenge' + '?access_token=' + invalidtoken,  null)
  .inspectJSON()
  .expectStatus(400)
  .expectJSONTypes({
      response: Object
...
frisby.create('Post undefined and receive 400 error with valid' + host )
  .post(host + 'api/challenge' + '?access_token=' + invalidtoken)
  .inspectJSON()
  .expectStatus(400)
  .expectJSONTypes({
      response: Object
